...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team play and compete in interscholastic basketball games",
        "schedule": "Mondays, Wednesdays, Fridays, 5:00 PM - 7:00 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "jordan@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Build flexibility, mindfulness, and strength through yoga",
    ...
    "Drama Club": {
        "description": "Work on acting, stagecraft, and prepare performances",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["mia@mergington.edu", "jacob@mergington.edu"]
    },
    "Science Club": {
